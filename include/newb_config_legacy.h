...
#define NL_CAVE_BRIGHTNESS  0.35 // 0.0 dark ~ 2.0 bright
...
#define NL_DAY_SKY_CLARITY 1.0 // 0.0 foggy sky ~ 1.0 clear sky
...
/* Waving */
#define NL_PLANTS_WAVE 0.4   // [toggle] 0.02 gentle ~ 0.4 violent
